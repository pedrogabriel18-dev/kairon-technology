/* components.js v3 — navbar, footer, cookie banner */
(function(){
...
<nav id="navbar">
  <div class="container nav-inner">
    <a href="index.html" class="nav-logo">
      <img src="assets/images/logokaironbranco.jpg" alt="Kairon Technology" id="nav-logo-img"/>
    </a>
    <ul class="nav-links">
    ...
    <div class="footer-grid">
      <div class="footer-brand">
        <a href="index.html" class="nav-logo" style="margin-bottom:20px;display:inline-flex">
          <img src="assets/images/logokaironbranco.jpg" alt="Kairon Technology" style="height:40px;width:auto"/>
        </a>
      ...
      <div>
        ...
        <ul class="footer-links">
          <li><a href="services.html">Physical Security</a></li>
          <li><a href="services.html">Executive Protection</a></li>
          <li><a href="services.html">Cyber Intelligence</a></li>
          <li><a href="services.html">Tactical Operations</a></li>
        </ul>
      </div>
      <div>
